...
ARTIFACT_DIR="$ROOT_DIR/devtools/reports/benchmark_artifacts/prefix_consumption"
...
echo "Running Python prefix consumption benchmark..."
TYPEFLOW_DIAGNOSTICS_LOG="$DIAGNOSTICS_LOG" python3 "$SCRIPT_DIR/prefix_consumption_benchmark.py"
