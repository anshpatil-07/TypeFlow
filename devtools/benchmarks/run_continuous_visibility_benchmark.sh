...
ARTIFACT_DIR="$ROOT_DIR/devtools/reports/benchmark_artifacts/continuous_visibility"
...
TYPEFLOW_DIAGNOSTICS_LOG="$DIAGNOSTICS_LOG" python3 "$SCRIPT_DIR/continuous_visibility_benchmark.py"

echo "Analyzing results..."
python3 "$SCRIPT_DIR/analyze_continuous_visibility_benchmark.py"
