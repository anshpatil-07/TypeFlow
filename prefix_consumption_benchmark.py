...
ARTIFACT_DIR = ROOT / "benchmark_artifacts" / "prefix_consumption"
RESULTS_PATH = ARTIFACT_DIR / "results.json"
DIAGNOSTICS_LOG = os.environ.get("TYPEFLOW_DIAGNOSTICS_LOG", ROOT / "benchmark_artifacts" / "prefix_consumption" / "typeflow_diagnostics.log")
