...
ARTIFACT_DIR="$ROOT_DIR/benchmark_artifacts"
...
python3 "$ROOT_DIR/safari_product_benchmark.py"

python3 "$ROOT_DIR/analyze_safari_product_benchmark.py" --results "$RESULTS_JSON" --report "$REPORT_MD"
